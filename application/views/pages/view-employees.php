    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo $tran->UserFirstName ?></td>
                <td><?php echo $tran->UserLastName ?></td>
                <td><?php echo $tran->UserPosition ?></td>
                <td><?php echo $tran->UserProfession ?></td>
                <td><?php echo $tran->UserLicenseNumber ?></td>
                <td><?php echo $tran->UserAccountType ?></td>
            </tr>
            <?php } ?>
        </tbody>
    </table>
