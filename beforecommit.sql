...
INSERT INTO `codegenerator` VALUES ('AUI',1),('AUR',1),('CAI',1),('CAR',1),('NZI',1),('NZR',1),('USI',1),('USR',1);
...
INSERT INTO `patient` VALUES ('1451234','Dela Cruz ','Nicolas','Arevalo','1990-01-21','M'),('1451235','Espino','Jessica Marie','San Pedro','2014-02-01','F'),('1451236','Gomez','Chrisanta','Alfero','1984-08-25','F'),('1451237','Santiago','Federico','Sanchez','1956-12-25','M'),('1461238','Santiago','Esmeralda','Felipe','1956-07-14','F'),('1471239','De Guzman','Patrick','Pelayo','1972-03-31','M'),('1484444','Villegas','John','Tan','1986-04-29','M'),('1484445','Villegas','Edward','Tan','1988-02-11','M');
...
INSERT INTO `sputumcollectionschedulelog` VALUES (1,8,'2019-11-18',1,'Pending');
...
INSERT INTO `sputumrequestlog` VALUES (1,'1451234','Initial',3,'Dr. EMV','2019-11-19','US','Pending'),(2,'1451235','Initial',3,'Dr. EMV','2019-11-19','US','Pending'),(3,'1451236','Initial',3,'Dr. EMV','2019-11-19','US','Pending'),(4,'1451237','Initial',3,'Dr. EMV','2019-10-16','US','Scheduled'),(5,'1451237','Repeat',2,'Dr. DM','2019-11-19','US','Pending'),(6,'1461238','Initial',3,'Dr. ET','2019-11-19','CA','Pending'),(7,'1471239','Initial',3,'Dr. ET','2019-11-19','AU','Pending'),(8,'1484444','Initial',3,'Dr. DM','2019-11-19','NZ','Scheduled'),(9,'1484445','Initial',3,'Dr. DM','2019-11-20','NZ','Pending');
...
INSERT INTO `testlist` VALUES (1,'Genexpert'),(2,'Drug Susceptibility Test');
...
INSERT INTO `transactionlist` VALUES (1,'Set Sputum Collection Schedule'),(2,'Assign Specimen Code'),(3,'Set Pulmonary Evaluation Sched'),(4,'Start Incubation'),(5,'Encode Smear Result'),(6,'Encode MGIT Final Result'),(7,'Encode LJ Final Result'),(8,'Encode Final Culture Result'),(9,'Request for Work-up'),(10,'Encode Genexpert Result'),(11,'Encode DST Result');
...
INSERT INTO `transactionlog` VALUES (1,1,168,'2019-11-19 20:38:00');
...
INSERT INTO `users` VALUES (21,'delacruzr','Dela Cruz','Raymundo',NULL,'Pathologist','Pathologist',16821,'admin',0),(32,'villarealm','Villareal','Ma. Cecilia',NULL,'Manager','Medical Technologist',33342,'admin',0),(45,'santosh','Santos','Hermie',NULL,'Staff','Medical Technologist',31699,'basic',0),(168,'mantalaj','Mantala','Jian Carli',NULL,'Assistant Manager','Medical Technologist',50538,'admin',0),(208,'domingom','Domingo','Mathew',NULL,'Staff','Medical Technologist',50496,'basic',0),(222,'andradeh','Andrade','Hazel Anne',NULL,'Staff','Medical Technologist',50465,'basic',0),(345,'punzalanc','Punzalan','Charlene',NULL,'Staff','Medical Technologist',52516,'basic',0);
...
-- Dump completed on 2019-11-20  7:24:23
